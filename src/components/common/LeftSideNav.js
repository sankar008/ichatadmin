...
import * as leftSideImg from '../../assets/images/ImgLib'
...
<div className="leftside-menu">
    ...
    <a href="index.html" className="logo logo-light">
        <span className="logo-lg">
            <img src={ leftSideImg.logoLight } alt="logo" />
        </span>
        <span className="logo-sm">
            <img src={ leftSideImg.logoLight } alt="small logo" />
        </span>
    </a>
    ...
    <a href="index.html" className="logo logo-dark">
        <span className="logo-lg">
            <img src={ leftSideImg.logoLight } alt="dark logo" />
        </span>
        <span className="logo-sm">
            <img src={ leftSideImg.logoLight } alt="small logo" />
        </span>
        ...
        <ul className="side-nav">
            ...
            <li className="side-nav-item">
                ...
                <div className="collapse" id="sidebarLayouts">
                    <ul className="side-nav-second-level">̥̥̥
                        <li>
                            <a href="layouts-horizontal.html" target="_blank">Horizontal</a>̥̥
                        </li>
                        <li>
            ...
            <div className="help-box text-white text-center">
                ...
                <a href="#" className="btn btn-secondary btn-sm">Upgrade</a>
            </div>
